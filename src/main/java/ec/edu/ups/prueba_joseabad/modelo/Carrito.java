...
public class Carrito {
    ...
    public Carrito(Date fecha, double subtotal, double codigo) {
        this.fecha = fecha;
    ...
    public double calcularIva(Carrito carrito){
        double Iva = carrito.getSubtotal()*0.12;
     return Iva;   
    }
    
    public double calcularTotal(Carrito carrito){
        double Total = carrito.getSubtotal() + carrito.getIva();
        return Total;
    }
}
